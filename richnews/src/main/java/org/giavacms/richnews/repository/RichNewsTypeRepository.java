...
@Stateless
@LocalBean
public class RichNewsTypeRepository extends AbstractRepository<RichNewsType> {
	...
	@Override
	protected void applyRestrictions(Search<RichNewsType> search, String alias,
	...
	public boolean delete(Object key) {
		try {
			RichNewsType richNewsType = getEm().find(getEntityType(), key);
			if (richNewsType != null) {
				richNewsType.setActive(false);
				getEm().merge(richNewsType);
			}
			return true;
		} catch (Exception e) {
