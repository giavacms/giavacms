...
public abstract class I18nSupport implements I18Nable, Serializable
{
   ...
   public boolean isI18N(int test)
   {
      if (id == null)
      {
         return false;
      ...
      {
      case 1:
         return id.equals(lang1id);
      case 2:
         return id.equals(lang2id);
      case 3:
         return id.equals(lang3id);
      case 4:
         return id.equals(lang4id);
      case 5:
         return id.equals(lang4id);
      default:
         return false;
   ...
   public String getI18N(long lang)
   {
      return getI18N((int) lang);
   }
