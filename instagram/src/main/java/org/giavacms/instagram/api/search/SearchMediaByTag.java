...
public class SearchMediaByTag {
	...
	public static PaginationResult execute(String accessToken,
			String max_tag_id, String tag, boolean debug) throws Exception {
		Map<String, String> params = new HashMap<String, String>();
		params.put("access_token", accessToken);
		if (max_tag_id != null && !max_tag_id.trim().isEmpty())
			params.put("max_tag_id", max_tag_id);
		String toJson = HttpUtils
				.getQueryWithParams(params, "https", "api.instagram.com/v1",
						"/tags/" + tag + "/media/recent", debug);
	...
	public static void main(String[] args) throws Exception {
		PaginationResult result = execute(TOKEN, "1335992121537",
				"176071718492615078_5624011", true);
	...
	public static void main2(String[] args) throws ClientProtocolException,
		...
		queryParamas.add(new BasicNameValuePair("max_tag_id", "1335992121537"));

		// 1336020887304

		URI uri = URIUtils.createURI("https",
				"api.instagram.com/v1/tags/arteinsieme", -1, "/media/recent",
