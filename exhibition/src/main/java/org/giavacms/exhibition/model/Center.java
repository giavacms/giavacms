...
@Entity
@Table(name = "ExhibitionCenter")
@DiscriminatorValue(value = Center.TYPE)
public class Center extends Subject implements Serializable
{

   private static final long serialVersionUID = 1L;
   public static final String TYPE = "CEN";
