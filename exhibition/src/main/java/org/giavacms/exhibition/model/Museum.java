...
@Entity
@Table(name = "ExhibitionMuseum")
@DiscriminatorValue(value = Museum.TYPE)
public class Museum extends Subject implements Serializable
{

   private static final long serialVersionUID = 1L;
   public static final String TYPE = "MUS";
